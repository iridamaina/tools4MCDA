#' Converts the estimated spatial fishing effort in the format of table I of the FDI data call (version 2 - detailed).
#'
#' Using the predicted spatial fishing effort in a csquare of 0.5 * 0.5 decimal degrees cell size to export a dataframe in the format of spatial effort (Table I) of the FDI data call (version 2 - detailed).
#'
#'
...
#'                     target_assemblage="target_assemblage", metier="metier",,metier_7="metier_7",mesh_size_range="mesh_size_range",LON="LON", LAT="LAT")
#'
...
#' @export
create_tableI2<-function (data=ERS_gns_06_q,country="Country",	year="year",	quarter="quarter",	vessel_length="vessel_length",
                         fishing_tech="fishing_tech", gear_type="gear_type",	target_assemblage="target_assemblage",
                         mesh_size_range="mesh_size_range",	metier="metier",	metier_7="metier_7",	supra_region="MBS",
                         sub_region="Sub.region",	eez_indicator="NA",	geo_indicator="NK",	specon_tech="NK",
                         deep="NA",	rectangle_type="05*05",	latitude="csq_y",	longitude="csq_x",	c_square="NA",	
