#' Converts the estimated spatial landings' weight and value in the format of table H of the FDI data call (version 2 - detailed)
#'
#' Using the predicted spatial landings' weight and value in a csquare of 0.5 * 0.5 decimal degrees cell size to export a dataframe in the format of spatial landings (Table H) of the FDI data call (version 2 - detailed).
#'
#'
...
#' @param mesh_size_range The name of the field in the dataframe containing the mesh_size_range
#' @param metier The name of the field in the dataframe containing the metier
#' @param metier_7 The name of the field in the dataframe containing the metier_7
...
#'                                   mesh_size_range="mesh_size_range",	metier="metier",	metier_7="metier_7",	supra_region="MBS",
...
#' @export
create_tableH2<-function (data=ERS_gns_06_q_catch,country="Country",	year="year",	quarter="quarter",	vessel_length="vessel_length",
                         fishing_tech="fishing_tech", gear_type="gear_type",	target_assemblage="target_assemblage",
                         mesh_size_range="mesh_size_range",	metier="metier",	metier_7="metier_7",	supra_region="MBS",
                         sub_region="Sub.region",	eez_indicator="NA",	geo_indicator="NK",	specon_tech="NK",
                         deep="NA",	rectangle_type="05*05",	latitude="csq_y",	longitude="csq_x",c_square="NA", species="species",	
                         totwghtlandg="parameter",	totvallandg="parameter2",confidential="N")
{
  ...
  tableI$mesh_size_range <- FPI[[mesh_size_range]]
  tableI$metier <- FPI[[metier]]
  tableI$metier_7 <- 	FPI[[metier_7]]
